        ...
        >
          ...
          >
            <div className="w-full flex flex-col items-center justify-center gap-[2vh]">
              ...
              >
                <span className="text-black">Conversa con GLYNNE</span>
              </motion.h2>
              ...
              >
                Este espacio está diseñado para que hables directamente con <strong>GLYNNE</strong>, 
                nuestro especialista en Inteligencia Artificial, y juntos puedan construir ideas claras 
                sobre cómo adaptar tu negocio a las nuevas tecnologías.  
                Aquí recibirás orientación precisa y práctica para tomar decisiones estratégicas.
              </p>
              ...
              <div className="pt-4 flex flex-col items-center">
                ...
                >
                  Iniciar conversación con GLYNNE
                </motion.button>
                ...
                >
                  ¿Quieres auditar procesos? Visita GLY_AI
                </a>
              </div>
            </div>
          </motion.div>
