...
export default function PerfilUsuario() {
  ...
  return (
    ...
    <span className="font-bold text-black">GLYNNE ASISTENT</span>.
        </p>
        <p className="text-xs text-gray-400 mt-1">
          Tu copiloto de voz para adaptarte al futuro: piensa, conversa y automatiza como en la era de la IA.
        </p>
      </div>
    </div>
  );
